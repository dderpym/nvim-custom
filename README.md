...
I've recently switched to LazyVim (okay, like a year ago) and I've been thinking about how to switch this over.

The old NvChad config is still available on the nvchad branch but will not be maintained (and honestly I'm not even sure if it still works).

I don't actually expect that anyone actually uses this config other than myself, but I can always pretend. Besides, if you're reading the README, clearly I'm wrong, right?
